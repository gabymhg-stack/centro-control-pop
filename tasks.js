  ...
  try {
    if (req.method === 'GET') {
      ...
      const { rows } = await db.query(
        ...
        [b.titulo, b.area||'', b.responsable||'Gaby', b.prioridad||'Media',
         b.estado||'Pendiente', b.fecha||'', b.tipo||'Tarea general',
         b.notas||'', !!b.top, !!b.flag]
      );
      ...
      const { rows } = await db.query(
        `UPDATE tasks SET titulo=$1,area=$2,responsable=$3,prioridad=$4,
         estado=$5,fecha=$6,tipo=$7,notas=$8,top=$9,flag=$10
         WHERE id=$11 RETURNING *`,
        [b.titulo, b.area||'', b.responsable||'', b.prioridad||'Media',
         b.estado||'Pendiente', b.fecha||'', b.tipo||'Tarea general',
         b.notas||'', !!b.top, !!b.flag, id]
      );
